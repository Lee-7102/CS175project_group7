...
class Simulation:
    def __init__(self, Model, Memory, TrafficGen, sumo_cmd, gamma, max_steps, green_duration, yellow_duration, num_states, num_actions, training_epochs, update_target_epochs):
        self._Model = Model
    ...
    def _replay(self):
        ...
        if len(batch) > 0:  # if the memory is full enough
            ...
            x = np.zeros((len(batch), self._num_states))#states
            y = np.zeros((len(batch), self._num_actions))#q
